...
function SubmitButton() {
    ...
    return (
        <Button className="h-10" type="submit" aria-disabled={pending}>
            <svg
                fill="#000000"
                height="200px"
                width="200px"
...
export default function Home() {
    ...
    return (
        <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
            <form className="flex flex-row gap-2 items-end" action={formAction}>
                <Textarea className="resize-none h-10" name="chat" placeholder="Message B-CRAB" autoComplete="false"/>
                <SubmitButton />
            </form>
